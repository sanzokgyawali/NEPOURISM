		    ...
		    <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
					 ...
					 <li>
                        <a href="<?php echo 'addroutes' ?>" class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i> <span class="nav-label">Available Routes Add</span> </a>
                    </li>
                    <li>
                        <a href="<?php echo 'availableroute' ?>" class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i> <span class="nav-label">Available Routes</span> </a>
                    </li>
                    <li>
                         <a href="<?php echo 'sentmessage' ?>" class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i> <span class="nav-label">Messages Sent</span> </a>
                    </li>
                     <li>
                         <a href="<?php echo 'recievemessage' ?>" class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i> <span class="nav-label">Messages Recieve</span> </a>
                    </li>
